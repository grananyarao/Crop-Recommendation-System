...
body {
  ...
  color: var(--text);
  background:
    radial-gradient(circle at top left, rgba(90, 242, 165, 0.16), transparent 25%),
    radial-gradient(circle at top right, rgba(77, 199, 255, 0.16), transparent 25%),
...
.cursor-glow {
  ...
  pointer-events: none;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(90, 242, 165, 0.18), transparent 65%);
...
.floating-1 {
  width: 220px;
  height: 220px;
  background: rgba(90, 242, 165, 0.18);
  top: 12%;
  left: 6%;
}
...
.floating-3 {
  width: 160px;
  height: 160px;
  background: rgba(200, 255, 100, 0.16);
  top: 18%;
  right: 25%;
  animation-delay: 3s;
}
...
.mini-box {
  background: rgba(90, 242, 165, 0.08);
  border: 1px solid rgba(90, 242, 165, 0.22);
}
...
.form-grid input:focus {
  ...
  box-shadow: 0 0 0 1px rgba(90, 242, 165, 0.45);
}
...
.weather-label input:focus {
  ...
  box-shadow: 0 0 0 1px rgba(77, 199, 255, 0.45);
}
...
/* --- DISEASE DETECTION SECTION STYLES --- */
...
.file-drop {
  ...
  margin-bottom: 20px;
  background: radial-gradient(circle at top left, rgba(90, 242, 165, 0.12), transparent 55%);
}
...
.file-drop.file-drop--active {
  border-color: var(--primary);
  background: radial-gradient(circle at top left, rgba(90, 242, 165, 0.18), transparent 60%);
...
.stApp {
    background:
        radial-gradient(
            circle at top left,
            rgba(90, 242, 165, 0.16),
            transparent 25%
        ),
        radial-gradient(
            circle at top right,
            rgba(77, 199, 255, 0.16),
            transparent 25%
        ),
        linear-gradient(
            135deg,
...
.stTextInput input {
    ...
    -webskit-text-fill-color: #ffffff !importtant;
}
...
st.markdown(
    "# Find the right <span style='color:#5af2a5;'>crop</span> for your soil.",
    unsafe_allow_html=True
)
